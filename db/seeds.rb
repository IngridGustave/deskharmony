...
laura = User.new(email:"laura@deskharmony.com", password: "coucou", first_name: "Laura", last_name: "Vidal", job_title: "Developer", nickname: "Laura" )
...
fabien = User.new(email:"fabien@deskharmony.com", password: "coucou", first_name: "Fabien", last_name: "Pittiani", job_title: "Developer", nickname: "Fabien" )
...
ingrid = User.new(email:"ingrid@deskharmony.com", password: "coucou", first_name: "Ingrid", last_name: "Gustave", job_title: "Developer", nickname: "Ingrid" )
...
julien = User.new(email:"julien@deskharmony.com", password: "coucou", first_name: "Julien", last_name: "Marchand", job_title: "Frog analyst", nickname: "Julien" )
...
maelie = User.new(email:"maelie@deskharmony.com", password: "coucou", first_name: "Maelie", last_name: "Poussier", job_title: "Senior Developer", nickname: "Maelie" )
...
alexis = User.new(email:"alexis@deskharmony.com", password: "coucou", first_name: "Alexis", last_name: "Stephan", job_title: "Data scientist", nickname: "Alexis" )
...
thibaud = User.new(email:"thibaud@deskharmony.com", password: "coucou", first_name: "Thibaud", last_name: "Maurel", job_title: "Data engineer", nickname: "Alexis" )
thibaud_file = URI.open('https://res.cloudinary.com/dvarz39fw/image/upload/v1711562357/T02NE0241-UHSMW24EA-7326d1313ea8-512_ss8wam.jpg')
thibaud.photo.attach(io: thibaud_file, filename: "thibaud.png", content_type: "image/png")
thibaud.save
...
# seb = User.new(email:"seb@deskharmony.com", password: "coucou", first_name: "Sebastien", last_name: "Saunier", job_title: "Business analyst", nickname: "Seb" )
...
Appointment.create!(user_id: fabien.id, desk_id: Desk.find_by(name: 25).id, start_at: "2024-01-27")
Appointment.create!(user_id: fabien.id, desk_id: Desk.find_by(name: 20).id, start_at: "2024-01-28")
Appointment.create!(user_id: fabien.id, desk_id: Desk.find_by(name: 3).id, start_at: "2024-01-29")
Appointment.create!(user_id: fabien.id, desk_id: Desk.find_by(name: 3).id, start_at: "2024-02-05")
Appointment.create!(user_id: fabien.id, desk_id: Desk.find_by(name: 7).id, start_at: "2024-02-06")
Appointment.create!(user_id: fabien.id, desk_id: Desk.find_by(name: 11).id, start_at: "2024-02-07")
Appointment.create!(user_id: fabien.id, desk_id: Desk.find_by(name: 21).id, start_at: "2024-02-14")
Appointment.create!(user_id: fabien.id, desk_id: Desk.find_by(name: 3).id, start_at: "2024-02-15")
Appointment.create!(user_id: fabien.id, desk_id: Desk.find_by(name: 4).id, start_at: "2024-02-16")
Appointment.create!(user_id: fabien.id, desk_id: Desk.find_by(name: 4).id, start_at: "2024-02-19")
Appointment.create!(user_id: fabien.id, desk_id: Desk.find_by(name: 9).id, start_at: "2024-02-20")
Appointment.create!(user_id: fabien.id, desk_id: Desk.find_by(name: 7).id, start_at: "2024-02-21")
Appointment.create!(user_id: fabien.id, desk_id: Desk.find_by(name: 7).id, start_at: "2024-02-26")
Appointment.create!(user_id: fabien.id, desk_id: Desk.find_by(name: 18).id, start_at: "2024-02-27")
Appointment.create!(user_id: fabien.id, desk_id: Desk.find_by(name: 24).id, start_at: "2024-02-29")
Appointment.create!(user_id: fabien.id, desk_id: Desk.find_by(name: 11).id, start_at: "2024-03-04")
Appointment.create!(user_id: fabien.id, desk_id: Desk.find_by(name: 19).id, start_at: "2024-03-05")
Appointment.create!(user_id: fabien.id, desk_id: Desk.find_by(name: 14).id, start_at: "2024-03-06")
Appointment.create!(user_id: fabien.id, desk_id: Desk.find_by(name: 26).id, start_at: "2024-03-11")
Appointment.create!(user_id: fabien.id, desk_id: Desk.find_by(name: 5).id, start_at: "2024-03-12")
Appointment.create!(user_id: fabien.id, desk_id: Desk.find_by(name: 4).id, start_at: "2024-03-14")
...
Appointment.create!(user_id: ingrid.id, desk_id: Desk.find_by(name: 26).id, start_at: "2024-01-27")
Appointment.create!(user_id: ingrid.id, desk_id: Desk.find_by(name: 21).id, start_at: "2024-01-28")
Appointment.create!(user_id: ingrid.id, desk_id: Desk.find_by(name: 4).id, start_at: "2024-01-29")
Appointment.create!(user_id: ingrid.id, desk_id: Desk.find_by(name: 4).id, start_at: "2024-02-05")
Appointment.create!(user_id: ingrid.id, desk_id: Desk.find_by(name: 8).id, start_at: "2024-02-06")
Appointment.create!(user_id: ingrid.id, desk_id: Desk.find_by(name: 12).id, start_at: "2024-02-07")
Appointment.create!(user_id: ingrid.id, desk_id: Desk.find_by(name: 22).id, start_at: "2024-02-14")
Appointment.create!(user_id: ingrid.id, desk_id: Desk.find_by(name: 4).id, start_at: "2024-02-15")
Appointment.create!(user_id: ingrid.id, desk_id: Desk.find_by(name: 5).id, start_at: "2024-02-16")
Appointment.create!(user_id: ingrid.id, desk_id: Desk.find_by(name: 5).id, start_at: "2024-02-19")
Appointment.create!(user_id: ingrid.id, desk_id: Desk.find_by(name: 10).id, start_at: "2024-02-20")
Appointment.create!(user_id: ingrid.id, desk_id: Desk.find_by(name: 8).id, start_at: "2024-02-21")
Appointment.create!(user_id: ingrid.id, desk_id: Desk.find_by(name: 8).id, start_at: "2024-02-26")
Appointment.create!(user_id: ingrid.id, desk_id: Desk.find_by(name: 19).id, start_at: "2024-02-27")
Appointment.create!(user_id: ingrid.id, desk_id: Desk.find_by(name: 25).id, start_at: "2024-02-29")
Appointment.create!(user_id: ingrid.id, desk_id: Desk.find_by(name: 12).id, start_at: "2024-03-04")
Appointment.create!(user_id: ingrid.id, desk_id: Desk.find_by(name: 20).id, start_at: "2024-03-05")
Appointment.create!(user_id: ingrid.id, desk_id: Desk.find_by(name: 15).id, start_at: "2024-03-06")
...
Appointment.create!(user_id: julien.id, desk_id: Desk.find_by(name: 27).id, start_at:  '2024-01-27')
Appointment.create!(user_id: julien.id, desk_id: Desk.find_by(name: 22).id, start_at:  '2024-01-28')
Appointment.create!(user_id: julien.id, desk_id: Desk.find_by(name: 5).id, start_at:  '2024-01-29')
Appointment.create!(user_id: julien.id, desk_id: Desk.find_by(name: 5).id, start_at:  '2024-02-05')
Appointment.create!(user_id: julien.id, desk_id: Desk.find_by(name: 9).id, start_at:  '2024-02-06')
Appointment.create!(user_id: julien.id, desk_id: Desk.find_by(name: 13).id, start_at:  '2024-02-07')
Appointment.create!(user_id: julien.id, desk_id: Desk.find_by(name: 23).id, start_at:  '2024-02-14')
Appointment.create!(user_id: julien.id, desk_id: Desk.find_by(name: 5).id, start_at:  '2024-02-15')
Appointment.create!(user_id: julien.id, desk_id: Desk.find_by(name: 6).id, start_at:  '2024-02-16')
Appointment.create!(user_id: julien.id, desk_id: Desk.find_by(name: 6).id, start_at:  '2024-02-19')
Appointment.create!(user_id: julien.id, desk_id: Desk.find_by(name: 11).id, start_at:  '2024-02-20')
Appointment.create!(user_id: julien.id, desk_id: Desk.find_by(name: 9).id, start_at:  '2024-02-21')
Appointment.create!(user_id: julien.id, desk_id: Desk.find_by(name: 9).id, start_at:  '2024-02-26')
Appointment.create!(user_id: julien.id, desk_id: Desk.find_by(name: 20).id, start_at:  '2024-02-27')
Appointment.create!(user_id: julien.id, desk_id: Desk.find_by(name: 26).id, start_at:  '2024-02-29')
Appointment.create!(user_id: julien.id, desk_id: Desk.find_by(name: 13).id, start_at:  '2024-03-04')
Appointment.create!(user_id: julien.id, desk_id: Desk.find_by(name: 21).id, start_at:  '2024-03-05')
Appointment.create!(user_id: julien.id, desk_id: Desk.find_by(name: 16).id, start_at:  '2024-03-06')
Appointment.create!(user_id: julien.id, desk_id: Desk.find_by(name: 28).id, start_at:  '2024-03-11')
Appointment.create!(user_id: julien.id, desk_id: Desk.find_by(name: 7).id, start_at:  '2024-03-12')
...
Appointment.create!(user_id: alex.id, desk_id: Desk.find_by(name: 27).id, start_at:  '2024-01-16')
Appointment.create!(user_id: alex.id, desk_id: Desk.find_by(name: 28).id, start_at:  '2024-01-27')
Appointment.create!(user_id: alex.id, desk_id: Desk.find_by(name: 23).id, start_at:  '2024-01-28')
Appointment.create!(user_id: alex.id, desk_id: Desk.find_by(name: 6).id, start_at:  '2024-01-29')
Appointment.create!(user_id: alex.id, desk_id: Desk.find_by(name: 6).id, start_at:  '2024-02-05')
Appointment.create!(user_id: alex.id, desk_id: Desk.find_by(name: 10).id, start_at:  '2024-02-06')
Appointment.create!(user_id: alex.id, desk_id: Desk.find_by(name: 14).id, start_at:  '2024-02-07')
Appointment.create!(user_id: alex.id, desk_id: Desk.find_by(name: 24).id, start_at:  '2024-02-14')
Appointment.create!(user_id: alex.id, desk_id: Desk.find_by(name: 6).id, start_at:  '2024-02-15')
Appointment.create!(user_id: alex.id, desk_id: Desk.find_by(name: 7).id, start_at:  '2024-02-16')
Appointment.create!(user_id: alex.id, desk_id: Desk.find_by(name: 7).id, start_at:  '2024-02-19')
Appointment.create!(user_id: alex.id, desk_id: Desk.find_by(name: 12).id, start_at:  '2024-02-20')
Appointment.create!(user_id: alex.id, desk_id: Desk.find_by(name: 10).id, start_at:  '2024-02-21')
Appointment.create!(user_id: alex.id, desk_id: Desk.find_by(name: 10).id, start_at:  '2024-02-26')
Appointment.create!(user_id: alex.id, desk_id: Desk.find_by(name: 21).id, start_at:  '2024-02-27')
Appointment.create!(user_id: alex.id, desk_id: Desk.find_by(name: 27).id, start_at:  '2024-02-29')
Appointment.create!(user_id: alex.id, desk_id: Desk.find_by(name: 14).id, start_at:  '2024-03-04')
Appointment.create!(user_id: alex.id, desk_id: Desk.find_by(name: 22).id, start_at:  '2024-03-05')
Appointment.create!(user_id: alex.id, desk_id: Desk.find_by(name: 17).id, start_at:  '2024-03-06')
Appointment.create!(user_id: alex.id, desk_id: Desk.find_by(name: 29).id, start_at:  '2024-03-11')
Appointment.create!(user_id: alex.id, desk_id: Desk.find_by(name: 8).id, start_at:  '2024-03-12')
Appointment.create!(user_id: alex.id, desk_id: Desk.find_by(name: 7).id, start_at:  '2024-03-14')
...
Appointment.create!(user_id: florine.id, desk_id: Desk.find_by(name: 29).id, start_at:  '2024-01-27')
Appointment.create!(user_id: florine.id, desk_id: Desk.find_by(name: 24).id, start_at:  '2024-01-28')
Appointment.create!(user_id: florine.id, desk_id: Desk.find_by(name: 7).id, start_at:  '2024-01-29')
Appointment.create!(user_id: florine.id, desk_id: Desk.find_by(name: 7).id, start_at:  '2024-02-05')
Appointment.create!(user_id: florine.id, desk_id: Desk.find_by(name: 11).id, start_at:  '2024-02-06')
Appointment.create!(user_id: florine.id, desk_id: Desk.find_by(name: 15).id, start_at:  '2024-02-07')
Appointment.create!(user_id: florine.id, desk_id: Desk.find_by(name: 25).id, start_at:  '2024-02-14')
Appointment.create!(user_id: florine.id, desk_id: Desk.find_by(name: 7).id, start_at:  '2024-02-15')
Appointment.create!(user_id: florine.id, desk_id: Desk.find_by(name: 8).id, start_at:  '2024-02-16')
Appointment.create!(user_id: florine.id, desk_id: Desk.find_by(name: 8).id, start_at:  '2024-02-19')
Appointment.create!(user_id: florine.id, desk_id: Desk.find_by(name: 13).id, start_at:  '2024-02-20')
Appointment.create!(user_id: florine.id, desk_id: Desk.find_by(name: 11).id, start_at:  '2024-02-21')
Appointment.create!(user_id: florine.id, desk_id: Desk.find_by(name: 11).id, start_at:  '2024-02-26')
Appointment.create!(user_id: florine.id, desk_id: Desk.find_by(name: 22).id, start_at:  '2024-02-27')
Appointment.create!(user_id: florine.id, desk_id: Desk.find_by(name: 28).id, start_at:  '2024-02-29')
Appointment.create!(user_id: florine.id, desk_id: Desk.find_by(name: 15).id, start_at:  '2024-03-04')
Appointment.create!(user_id: florine.id, desk_id: Desk.find_by(name: 23).id, start_at:  '2024-03-05')
Appointment.create!(user_id: florine.id, desk_id: Desk.find_by(name: 18).id, start_at:  '2024-03-06')
Appointment.create!(user_id: florine.id, desk_id: Desk.find_by(name: 30).id, start_at:  '2024-03-11')
Appointment.create!(user_id: florine.id, desk_id: Desk.find_by(name: 9).id, start_at:  '2024-03-12')
Appointment.create!(user_id: florine.id, desk_id: Desk.find_by(name: 8).id, start_at:  '2024-03-14')
...
Appointment.create!(user_id: charlie.id, desk_id: Desk.find_by(name: 30).id, start_at:  '2024-01-27')
Appointment.create!(user_id: charlie.id, desk_id: Desk.find_by(name: 25).id, start_at:  '2024-01-28')
Appointment.create!(user_id: charlie.id, desk_id: Desk.find_by(name: 8).id, start_at:  '2024-01-29')
Appointment.create!(user_id: charlie.id, desk_id: Desk.find_by(name: 8).id, start_at:  '2024-02-05')
Appointment.create!(user_id: charlie.id, desk_id: Desk.find_by(name: 12).id, start_at:  '2024-02-06')
Appointment.create!(user_id: charlie.id, desk_id: Desk.find_by(name: 16).id, start_at:  '2024-02-07')
Appointment.create!(user_id: charlie.id, desk_id: Desk.find_by(name: 26).id, start_at:  '2024-02-14')
Appointment.create!(user_id: charlie.id, desk_id: Desk.find_by(name: 8).id, start_at:  '2024-02-15')
Appointment.create!(user_id: charlie.id, desk_id: Desk.find_by(name: 9).id, start_at:  '2024-02-16')
Appointment.create!(user_id: charlie.id, desk_id: Desk.find_by(name: 9).id, start_at:  '2024-02-19')
Appointment.create!(user_id: charlie.id, desk_id: Desk.find_by(name: 14).id, start_at:  '2024-02-20')
Appointment.create!(user_id: charlie.id, desk_id: Desk.find_by(name: 12).id, start_at:  '2024-02-21')
Appointment.create!(user_id: charlie.id, desk_id: Desk.find_by(name: 12).id, start_at:  '2024-02-26')
Appointment.create!(user_id: charlie.id, desk_id: Desk.find_by(name: 23).id, start_at:  '2024-02-27')
Appointment.create!(user_id: charlie.id, desk_id: Desk.find_by(name: 29).id, start_at:  '2024-02-29')
Appointment.create!(user_id: charlie.id, desk_id: Desk.find_by(name: 16).id, start_at:  '2024-03-04')
Appointment.create!(user_id: charlie.id, desk_id: Desk.find_by(name: 24).id, start_at:  '2024-03-05')
Appointment.create!(user_id: charlie.id, desk_id: Desk.find_by(name: 19).id, start_at:  '2024-03-06')
Appointment.create!(user_id: charlie.id, desk_id: Desk.find_by(name: 31).id, start_at:  '2024-03-11')
Appointment.create!(user_id: charlie.id, desk_id: Desk.find_by(name: 10).id, start_at:  '2024-03-12')
Appointment.create!(user_id: charlie.id, desk_id: Desk.find_by(name: 9).id, start_at:  '2024-03-14')
...
Appointment.create!(user_id: maelie.id, desk_id: Desk.find_by(name: 31).id, start_at:  '2024-01-27')
Appointment.create!(user_id: maelie.id, desk_id: Desk.find_by(name: 26).id, start_at:  '2024-01-28')
Appointment.create!(user_id: maelie.id, desk_id: Desk.find_by(name: 9).id, start_at:  '2024-01-29')
Appointment.create!(user_id: maelie.id, desk_id: Desk.find_by(name: 9).id, start_at:  '2024-02-05')
Appointment.create!(user_id: maelie.id, desk_id: Desk.find_by(name: 13).id, start_at:  '2024-02-06')
Appointment.create!(user_id: maelie.id, desk_id: Desk.find_by(name: 17).id, start_at:  '2024-02-07')
Appointment.create!(user_id: maelie.id, desk_id: Desk.find_by(name: 27).id, start_at:  '2024-02-14')
Appointment.create!(user_id: maelie.id, desk_id: Desk.find_by(name: 9).id, start_at:  '2024-02-15')
Appointment.create!(user_id: maelie.id, desk_id: Desk.find_by(name: 10).id, start_at:  '2024-02-16')
Appointment.create!(user_id: maelie.id, desk_id: Desk.find_by(name: 10).id, start_at:  '2024-02-19')
Appointment.create!(user_id: maelie.id, desk_id: Desk.find_by(name: 15).id, start_at:  '2024-02-20')
Appointment.create!(user_id: maelie.id, desk_id: Desk.find_by(name: 13).id, start_at:  '2024-02-21')
Appointment.create!(user_id: maelie.id, desk_id: Desk.find_by(name: 13).id, start_at:  '2024-02-26')
Appointment.create!(user_id: maelie.id, desk_id: Desk.find_by(name: 24).id, start_at:  '2024-02-27')
Appointment.create!(user_id: maelie.id, desk_id: Desk.find_by(name: 30).id, start_at:  '2024-02-29')
Appointment.create!(user_id: maelie.id, desk_id: Desk.find_by(name: 17).id, start_at:  '2024-03-04')
Appointment.create!(user_id: maelie.id, desk_id: Desk.find_by(name: 25).id, start_at:  '2024-03-05')
Appointment.create!(user_id: maelie.id, desk_id: Desk.find_by(name: 20).id, start_at:  '2024-03-06')
Appointment.create!(user_id: maelie.id, desk_id: Desk.find_by(name: 32).id, start_at:  '2024-03-11')
Appointment.create!(user_id: maelie.id, desk_id: Desk.find_by(name: 11).id, start_at:  '2024-03-12')
Appointment.create!(user_id: maelie.id, desk_id: Desk.find_by(name: 10).id, start_at:  '2024-03-14')
...
Appointment.create!(user_id: gwendal.id, desk_id: Desk.find_by(name: 32).id, start_at:  '2024-01-27')
Appointment.create!(user_id: gwendal.id, desk_id: Desk.find_by(name: 27).id, start_at:  '2024-01-28')
Appointment.create!(user_id: gwendal.id, desk_id: Desk.find_by(name: 10).id, start_at:  '2024-01-29')
Appointment.create!(user_id: gwendal.id, desk_id: Desk.find_by(name: 10).id, start_at:  '2024-02-05')
Appointment.create!(user_id: gwendal.id, desk_id: Desk.find_by(name: 14).id, start_at:  '2024-02-06')
Appointment.create!(user_id: gwendal.id, desk_id: Desk.find_by(name: 18).id, start_at:  '2024-02-07')
Appointment.create!(user_id: gwendal.id, desk_id: Desk.find_by(name: 28).id, start_at:  '2024-02-14')
Appointment.create!(user_id: gwendal.id, desk_id: Desk.find_by(name: 10).id, start_at:  '2024-02-15')
Appointment.create!(user_id: gwendal.id, desk_id: Desk.find_by(name: 11).id, start_at:  '2024-02-16')
Appointment.create!(user_id: gwendal.id, desk_id: Desk.find_by(name: 11).id, start_at:  '2024-02-19')
Appointment.create!(user_id: gwendal.id, desk_id: Desk.find_by(name: 16).id, start_at:  '2024-02-20')
Appointment.create!(user_id: gwendal.id, desk_id: Desk.find_by(name: 14).id, start_at:  '2024-02-21')
Appointment.create!(user_id: gwendal.id, desk_id: Desk.find_by(name: 14).id, start_at:  '2024-02-26')
Appointment.create!(user_id: gwendal.id, desk_id: Desk.find_by(name: 25).id, start_at:  '2024-02-27')
Appointment.create!(user_id: gwendal.id, desk_id: Desk.find_by(name: 31).id, start_at:  '2024-02-29')
Appointment.create!(user_id: gwendal.id, desk_id: Desk.find_by(name: 18).id, start_at:  '2024-03-04')
Appointment.create!(user_id: gwendal.id, desk_id: Desk.find_by(name: 26).id, start_at:  '2024-03-05')
Appointment.create!(user_id: gwendal.id, desk_id: Desk.find_by(name: 21).id, start_at:  '2024-03-06')
Appointment.create!(user_id: gwendal.id, desk_id: Desk.find_by(name: 33).id, start_at:  '2024-03-11')
Appointment.create!(user_id: gwendal.id, desk_id: Desk.find_by(name: 12).id, start_at:  '2024-03-12')
Appointment.create!(user_id: gwendal.id, desk_id: Desk.find_by(name: 11).id, start_at:  '2024-03-14')
...
Appointment.create!(user_id: kevin.id, desk_id: Desk.find_by(name: 33).id, start_at: '2024-01-27')
Appointment.create!(user_id: kevin.id, desk_id: Desk.find_by(name: 28).id, start_at: '2024-01-28')
Appointment.create!(user_id: kevin.id, desk_id: Desk.find_by(name: 11).id, start_at: '2024-01-29')
Appointment.create!(user_id: kevin.id, desk_id: Desk.find_by(name: 11).id, start_at: '2024-02-05')
Appointment.create!(user_id: kevin.id, desk_id: Desk.find_by(name: 15).id, start_at: '2024-02-06')
Appointment.create!(user_id: kevin.id, desk_id: Desk.find_by(name: 19).id, start_at: '2024-02-07')
Appointment.create!(user_id: kevin.id, desk_id: Desk.find_by(name: 29).id, start_at: '2024-02-14')
Appointment.create!(user_id: kevin.id, desk_id: Desk.find_by(name: 11).id, start_at: '2024-02-15')
Appointment.create!(user_id: kevin.id, desk_id: Desk.find_by(name: 12).id, start_at: '2024-02-16')
Appointment.create!(user_id: kevin.id, desk_id: Desk.find_by(name: 12).id, start_at: '2024-02-19')
Appointment.create!(user_id: kevin.id, desk_id: Desk.find_by(name: 17).id, start_at: '2024-02-20')
Appointment.create!(user_id: kevin.id, desk_id: Desk.find_by(name: 15).id, start_at: '2024-02-21')
Appointment.create!(user_id: kevin.id, desk_id: Desk.find_by(name: 15).id, start_at: '2024-02-26')
Appointment.create!(user_id: kevin.id, desk_id: Desk.find_by(name: 26).id, start_at: '2024-02-27')
Appointment.create!(user_id: kevin.id, desk_id: Desk.find_by(name: 32).id, start_at: '2024-02-29')
Appointment.create!(user_id: kevin.id, desk_id: Desk.find_by(name: 19).id, start_at: '2024-03-04')
Appointment.create!(user_id: kevin.id, desk_id: Desk.find_by(name: 27).id, start_at: '2024-03-05')
Appointment.create!(user_id: kevin.id, desk_id: Desk.find_by(name: 22).id, start_at: '2024-03-06')
Appointment.create!(user_id: kevin.id, desk_id: Desk.find_by(name: 34).id, start_at: '2024-03-11')
Appointment.create!(user_id: kevin.id, desk_id: Desk.find_by(name: 13).id, start_at: '2024-03-12')
Appointment.create!(user_id: kevin.id, desk_id: Desk.find_by(name: 12).id, start_at: '2024-03-14')
...
Appointment.create!(user_id: alexis.id, desk_id: Desk.find_by(name: 34).id, start_at:  '2024-01-27')
Appointment.create!(user_id: alexis.id, desk_id: Desk.find_by(name: 29).id, start_at:  '2024-01-28')
Appointment.create!(user_id: alexis.id, desk_id: Desk.find_by(name: 12).id, start_at:  '2024-01-29')
Appointment.create!(user_id: alexis.id, desk_id: Desk.find_by(name: 12).id, start_at:  '2024-02-05')
Appointment.create!(user_id: alexis.id, desk_id: Desk.find_by(name: 16).id, start_at:  '2024-02-06')
Appointment.create!(user_id: alexis.id, desk_id: Desk.find_by(name: 20).id, start_at:  '2024-02-07')
Appointment.create!(user_id: alexis.id, desk_id: Desk.find_by(name: 30).id, start_at:  '2024-02-14')
Appointment.create!(user_id: alexis.id, desk_id: Desk.find_by(name: 12).id, start_at:  '2024-02-15')
Appointment.create!(user_id: alexis.id, desk_id: Desk.find_by(name: 13).id, start_at:  '2024-02-16')
Appointment.create!(user_id: alexis.id, desk_id: Desk.find_by(name: 13).id, start_at:  '2024-02-19')
Appointment.create!(user_id: alexis.id, desk_id: Desk.find_by(name: 18).id, start_at:  '2024-02-20')
Appointment.create!(user_id: alexis.id, desk_id: Desk.find_by(name: 16).id, start_at:  '2024-02-21')
Appointment.create!(user_id: alexis.id, desk_id: Desk.find_by(name: 16).id, start_at:  '2024-02-26')
Appointment.create!(user_id: alexis.id, desk_id: Desk.find_by(name: 27).id, start_at:  '2024-02-27')
Appointment.create!(user_id: alexis.id, desk_id: Desk.find_by(name: 33).id, start_at:  '2024-02-29')
Appointment.create!(user_id: alexis.id, desk_id: Desk.find_by(name: 20).id, start_at:  '2024-03-04')
Appointment.create!(user_id: alexis.id, desk_id: Desk.find_by(name: 28).id, start_at:  '2024-03-05')
Appointment.create!(user_id: alexis.id, desk_id: Desk.find_by(name: 23).id, start_at:  '2024-03-06')
Appointment.create!(user_id: alexis.id, desk_id: Desk.find_by(name: 35).id, start_at:  '2024-03-11')
Appointment.create!(user_id: alexis.id, desk_id: Desk.find_by(name: 14).id, start_at:  '2024-03-12')
Appointment.create!(user_id: alexis.id, desk_id: Desk.find_by(name: 13).id, start_at:  '2024-03-14')
...
Appointment.create!(user_id: thibaud.id, desk_id: Desk.find_by(name: 35).id, start_at:  '2024-01-27')
Appointment.create!(user_id: thibaud.id, desk_id: Desk.find_by(name: 30).id, start_at:  '2024-01-28')
Appointment.create!(user_id: thibaud.id, desk_id: Desk.find_by(name: 13).id, start_at:  '2024-01-29')
Appointment.create!(user_id: thibaud.id, desk_id: Desk.find_by(name: 13).id, start_at:  '2024-02-05')
Appointment.create!(user_id: thibaud.id, desk_id: Desk.find_by(name: 17).id, start_at:  '2024-02-06')
Appointment.create!(user_id: thibaud.id, desk_id: Desk.find_by(name: 21).id, start_at:  '2024-02-07')
Appointment.create!(user_id: thibaud.id, desk_id: Desk.find_by(name: 31).id, start_at:  '2024-02-14')
Appointment.create!(user_id: thibaud.id, desk_id: Desk.find_by(name: 13).id, start_at:  '2024-02-15')
Appointment.create!(user_id: thibaud.id, desk_id: Desk.find_by(name: 14).id, start_at:  '2024-02-16')
Appointment.create!(user_id: thibaud.id, desk_id: Desk.find_by(name: 14).id, start_at:  '2024-02-19')
Appointment.create!(user_id: thibaud.id, desk_id: Desk.find_by(name: 19).id, start_at:  '2024-02-20')
Appointment.create!(user_id: thibaud.id, desk_id: Desk.find_by(name: 17).id, start_at:  '2024-02-21')
Appointment.create!(user_id: thibaud.id, desk_id: Desk.find_by(name: 17).id, start_at:  '2024-02-26')
Appointment.create!(user_id: thibaud.id, desk_id: Desk.find_by(name: 28).id, start_at:  '2024-02-27')
Appointment.create!(user_id: thibaud.id, desk_id: Desk.find_by(name: 34).id, start_at:  '2024-02-29')
Appointment.create!(user_id: thibaud.id, desk_id: Desk.find_by(name: 21).id, start_at:  '2024-03-04')
Appointment.create!(user_id: thibaud.id, desk_id: Desk.find_by(name: 29).id, start_at:  '2024-03-05')
Appointment.create!(user_id: thibaud.id, desk_id: Desk.find_by(name: 24).id, start_at:  '2024-03-06')
Appointment.create!(user_id: thibaud.id, desk_id: Desk.find_by(name: 36).id, start_at:  '2024-03-11')
Appointment.create!(user_id: thibaud.id, desk_id: Desk.find_by(name: 15).id, start_at:  '2024-03-12')
Appointment.create!(user_id: thibaud.id, desk_id: Desk.find_by(name: 14).id, start_at:  '2024-03-14')
...
Appointment.create!(user_id: pierreyves.id, desk_id: Desk.find_by(name: 36).id, start_at:  '2024-01-27')
Appointment.create!(user_id: pierreyves.id, desk_id: Desk.find_by(name: 31).id, start_at:  '2024-01-28')
Appointment.create!(user_id: pierreyves.id, desk_id: Desk.find_by(name: 14).id, start_at:  '2024-01-29')
Appointment.create!(user_id: pierreyves.id, desk_id: Desk.find_by(name: 14).id, start_at:  '2024-02-05')
Appointment.create!(user_id: pierreyves.id, desk_id: Desk.find_by(name: 18).id, start_at:  '2024-02-06')
Appointment.create!(user_id: pierreyves.id, desk_id: Desk.find_by(name: 22).id, start_at:  '2024-02-07')
Appointment.create!(user_id: pierreyves.id, desk_id: Desk.find_by(name: 32).id, start_at:  '2024-02-14')
Appointment.create!(user_id: pierreyves.id, desk_id: Desk.find_by(name: 14).id, start_at:  '2024-02-15')
Appointment.create!(user_id: pierreyves.id, desk_id: Desk.find_by(name: 15).id, start_at:  '2024-02-16')
Appointment.create!(user_id: pierreyves.id, desk_id: Desk.find_by(name: 15).id, start_at:  '2024-02-19')
Appointment.create!(user_id: pierreyves.id, desk_id: Desk.find_by(name: 20).id, start_at:  '2024-02-20')
Appointment.create!(user_id: pierreyves.id, desk_id: Desk.find_by(name: 18).id, start_at:  '2024-02-21')
Appointment.create!(user_id: pierreyves.id, desk_id: Desk.find_by(name: 18).id, start_at:  '2024-02-26')
Appointment.create!(user_id: pierreyves.id, desk_id: Desk.find_by(name: 29).id, start_at:  '2024-02-27')
Appointment.create!(user_id: pierreyves.id, desk_id: Desk.find_by(name: 35).id, start_at:  '2024-02-29')
Appointment.create!(user_id: pierreyves.id, desk_id: Desk.find_by(name: 22).id, start_at:  '2024-03-04')
Appointment.create!(user_id: pierreyves.id, desk_id: Desk.find_by(name: 30).id, start_at:  '2024-03-05')
Appointment.create!(user_id: pierreyves.id, desk_id: Desk.find_by(name: 25).id, start_at:  '2024-03-06')
Appointment.create!(user_id: pierreyves.id, desk_id: Desk.find_by(name: 37).id, start_at:  '2024-03-11')
Appointment.create!(user_id: pierreyves.id, desk_id: Desk.find_by(name: 16).id, start_at:  '2024-03-12')
Appointment.create!(user_id: pierreyves.id, desk_id: Desk.find_by(name: 15).id, start_at:  '2024-03-14')
...
Appointment.create!(user_id: ines.id, desk_id: Desk.find_by(name: 37).id, start_at:  '2024-01-27')
Appointment.create!(user_id: ines.id, desk_id: Desk.find_by(name: 32).id, start_at:  '2024-01-28')
Appointment.create!(user_id: ines.id, desk_id: Desk.find_by(name: 15).id, start_at:  '2024-01-29')
Appointment.create!(user_id: ines.id, desk_id: Desk.find_by(name: 15).id, start_at:  '2024-02-05')
Appointment.create!(user_id: ines.id, desk_id: Desk.find_by(name: 19).id, start_at:  '2024-02-06')
Appointment.create!(user_id: ines.id, desk_id: Desk.find_by(name: 23).id, start_at:  '2024-02-07')
Appointment.create!(user_id: ines.id, desk_id: Desk.find_by(name: 33).id, start_at:  '2024-02-14')
Appointment.create!(user_id: ines.id, desk_id: Desk.find_by(name: 15).id, start_at:  '2024-02-15')
Appointment.create!(user_id: ines.id, desk_id: Desk.find_by(name: 16).id, start_at:  '2024-02-16')
Appointment.create!(user_id: ines.id, desk_id: Desk.find_by(name: 16).id, start_at:  '2024-02-19')
Appointment.create!(user_id: ines.id, desk_id: Desk.find_by(name: 21).id, start_at:  '2024-02-20')
Appointment.create!(user_id: ines.id, desk_id: Desk.find_by(name: 19).id, start_at:  '2024-02-21')
Appointment.create!(user_id: ines.id, desk_id: Desk.find_by(name: 19).id, start_at:  '2024-02-26')
Appointment.create!(user_id: ines.id, desk_id: Desk.find_by(name: 30).id, start_at:  '2024-02-27')
Appointment.create!(user_id: ines.id, desk_id: Desk.find_by(name: 36).id, start_at:  '2024-02-29')
Appointment.create!(user_id: ines.id, desk_id: Desk.find_by(name: 23).id, start_at:  '2024-03-04')
Appointment.create!(user_id: ines.id, desk_id: Desk.find_by(name: 31).id, start_at:  '2024-03-05')
Appointment.create!(user_id: ines.id, desk_id: Desk.find_by(name: 26).id, start_at:  '2024-03-06')
Appointment.create!(user_id: ines.id, desk_id: Desk.find_by(name: 38).id, start_at:  '2024-03-11')
Appointment.create!(user_id: ines.id, desk_id: Desk.find_by(name: 17).id, start_at:  '2024-03-12')
Appointment.create!(user_id: ines.id, desk_id: Desk.find_by(name: 16).id, start_at:  '2024-03-14')
...
team_thibaud = TeamUser.create!(team_id: data_team.id, user_id: thibaud.id)
